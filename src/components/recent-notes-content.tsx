...
export function RecentNotesContent() {
  const {
    data: notes,
    isLoading,
    isError,
  ...
  if (isError) {
    return (
      <Card className="col-span-full p-6">
        ...
        <CardDescription>
          There was a problem loading your recent notes. Please try again later.
        </CardDescription>
      </Card>
    );
  }
    ...
    return (
      <Card className="col-span-full border-dashed p-6">
        <div className="flex flex-col items-center justify-center gap-2 text-center">
          ...
          <CardDescription>
            Create your first note to get started with NoteBud.
          </CardDescription>
